  ...
  <div id="mian">
    ...
    <div id="content">
      ...
      <router-link tag="div" to="/movie/city" class="city_name">
        <span>大连</span><i class="ifonfont icon-lower-triangle"></i>
      </router-link>
...
#content .movie_menu{ width: 100%; height: 45px; border-bottom:lpx solid #e6e6e6; display: flex; justify-content:space-between;}
